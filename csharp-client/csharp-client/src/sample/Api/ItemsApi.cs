...
namespace sample.Api
{
    ...
    public interface IItemsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Items> GetItemsAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<Items>> GetItemsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class ItemsApi : IDisposable, IItemsApi
    {
        ...
        /// <returns></returns>
        public ItemsApi(sample.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ItemsApi(HttpClient client, sample.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ItemsApi(sample.Client.ISynchronousClient client, sample.Client.IAsynchronousClient asyncClient, sample.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            sample.Client.ApiResponse<Items> localVarResponse = GetItemsWithHttpInfo();
        ...
        /// <exception cref="sample.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Items</returns>
        public sample.Client.ApiResponse<Items> GetItemsWithHttpInfo()
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Items</returns>
        public async System.Threading.Tasks.Task<Items> GetItemsAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            sample.Client.ApiResponse<Items> localVarResponse = await GetItemsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Items)</returns>
        public async System.Threading.Tasks.Task<sample.Client.ApiResponse<Items>> GetItemsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
